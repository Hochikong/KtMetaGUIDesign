...
public class VerticalTab extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setPreferredSize(new java.awt.Dimension(200, 270));
...
//            java.util.logging.Logger.getLogger(VerticalTab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                labTab1.setPreferredSize(new Dimension(12, 60));
                labTab1.setVerticalAlignment(SwingConstants.CENTER);
