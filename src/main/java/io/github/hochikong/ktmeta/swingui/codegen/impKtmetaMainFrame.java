 ...
 * @author ckhoi
 */
public class impKtmetaMainFrame extends javax.swing.JFrame {

    /**
     * Creates new form KtmetaJFrame
     */
    public impKtmetaMainFrame() {
...
//        FlatIntelliJLaf.install();
    ...
    protected void impMenuItemNewMetaLibActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impMenuItemAddDatabaseActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impMenuItemAddIndexActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impMenuItemSettingsActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impMenuItemExitActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impMenuItemExportToCSVActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impMenuItemPluginsMenuActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impMenuItemAboutActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impBTNAddDatabaseActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impBTNAddESIndexActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impBTNAddMetaLibActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impBTNAggrSearcgActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impBTNAdvanceSearchActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impTreeMetadataLibsMouseClicked(java.awt.event.MouseEvent evt){}
    protected void impTreeMetadataLibsValueChanged(javax.swing.event.TreeSelectionEvent evt){}
    protected void impTreeDatabasesMouseClicked(java.awt.event.MouseEvent evt){}
    protected void impTreeDatabasesValueChanged(javax.swing.event.TreeSelectionEvent evt){}
    protected void impTreeIndicesMouseClicked(java.awt.event.MouseEvent evt){}
    protected void impTreeIndicesValueChanged(javax.swing.event.TreeSelectionEvent evt){}
    protected void impComboBoxFTAvailableMetaLibsItemStateChanged(java.awt.event.ItemEvent evt){}
    protected void impBTNFTSearchActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impRightTextPaneAbstractMouseClicked(java.awt.event.MouseEvent evt){}
    protected void impRightTextPaneTagsMouseClicked(java.awt.event.MouseEvent evt){}
    protected void impBTNRightPreviewManagerActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impBTNRunningTasksActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMAbstractCopyAllActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMAbstractCopySelectedActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMTagsAddCustomActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMTagsCopyAllActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMTagsCopySelectedActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMViewEnlargeActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impRightPreviewLabelMouseClicked(java.awt.event.MouseEvent evt){}
    protected void impPMRenameDatabaseActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMDBPropertiesEditActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMRemoveDatabaseActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMRenameIndicesActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMIndexPropertiesEditActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMRemoveIndexActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMRenameMetaLibActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMMetaLibPropertiesActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMImportDataToDBActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMSyncToESActionPerformed(java.awt.event.ActionEvent evt){}
    protected void impPMRemoveMetaLibActionPerformed(java.awt.event.ActionEvent evt){}
